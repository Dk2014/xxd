...
CREATE TABLE `player_info` (
  ...
  PRIMARY KEY (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=287 DEFAULT CHARSET=utf8mb4 COMMENT='玩家信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `player_mission_level_record` (
  ...
  KEY `idx_pid` (`pid`),
  KEY `idx_mission_id` (`mission_id`)
) ENGINE=InnoDB AUTO_INCREMENT=685 DEFAULT CHARSET=utf8mb4 COMMENT='关卡记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=292 DEFAULT CHARSET=utf8mb4 COMMENT='区域记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `player_role` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_pid` (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=348 DEFAULT CHARSET=utf8mb4 COMMENT='玩家角色数据';
/*!40101 SET character_set_client = @saved_cs_client */;
