...
INSERT INTO `item_type` VALUES (1,'特殊材料',999,'SpecialMaterial',7),(2,'材料',99,'Stuff',6),(3,'武器',1,'Weapon',1),(4,'战袍',1,'Clothes',2),(5,'靴子',1,'Shoe',3),(6,'饰品',1,'Accessories',4),(7,'功能道具',99,'FuncProp',8),(8,'战斗道具',99,'FightProp',5),(9,'礼包',1,'Chest',9),(10,'资源',999,'Resource',10);
...
CREATE TABLE `mail_attachments` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COMMENT='系统邮件附件';
/*!40101 SET character_set_client = @saved_cs_client */;

/*!40000 ALTER TABLE `mail_attachments` DISABLE KEYS */;
INSERT INTO `mail_attachments` VALUES (3,3,1,0,1),(4,3,31,0,1),(5,3,238,0,22),(6,2,0,3,1);
