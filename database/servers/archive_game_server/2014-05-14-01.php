...
INSERT INTO `mission` VALUES (1,1,0,'青竹林','',1),(2,1,6,'黑夜森林','',2),(3,1,6,'莲花峰','',3),(4,1,6,'熔岩火山','',4),(5,1,6,'宝藏密室','',5);
...
CREATE TABLE `skill_content` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COMMENT='绝招数据表';
/*!40101 SET character_set_client = @saved_cs_client */;

/*!40000 ALTER TABLE `skill_content` DISABLE KEYS */;
INSERT INTO `skill_content` VALUES (1,5,2,1),(2,6,1,0),(3,7,2,1),(4,8,3,2),(5,49,2,1),(6,50,1,2),(7,51,2,1),(8,52,1,2),(9,53,2,1),(10,54,2,1),(11,55,2,1),(12,56,2,1),(13,57,1,0);
