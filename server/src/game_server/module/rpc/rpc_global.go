...
func RemoteGetFriendsWithMultiLevel(playerId int64, callback func(*multi_level_api.GetOnlineFriend_Out)) {
	...
	Remote.Call(config.ServerCfg.GlobalServerId, mdb.RPC_Remote_GetFriendsWithMultiLevel, args, reply, mdb.TRANS_TAG_RPC_Call_GetFriendsWithMultiLevel, func(err error) {
...
func RemoteGetGlobalVipCount(callback func(int64)) {
	...
	Remote.Call(config.ServerCfg.GlobalServerId, mdb.RPC_Remote_GetGlobalVipCount, args, reply, mdb.TRANS_TAG_RPC_Call_GetGlobalVipCount, func(err error) {
...
func RemoteGetGlobalLevelVipCount(callback func([]int32)) {
	...
	Remote.Call(config.ServerCfg.GlobalServerId, mdb.RPC_Remote_GetGlobalLevelVipCount, args, reply, mdb.TRANS_TAG_RPC_Call_GetGlobalLevelVipCount, func(err error) {
...
func RemoteOperateGroupBuyCount(isAdd bool, callback func(int32)) {
	...
	Remote.Call(config.ServerCfg.GlobalServerId, mdb.RPC_Remote_OperateGroupBuyCount, args, reply, mdb.TRANS_TAG_RPC_Call_OperateGroupBuyCount, func(err error) {
...
func (this *globalPlayerInfoSets) callUpdatePlayerInfoSets() {
	...
	if len(this.sets) > 0 {
		...
		Remote.Call(config.ServerCfg.GlobalServerId, mdb.RPC_Remote_SetPlayerInfo, args, reply, mdb.TRANS_TAG_RPC_Call_SetPlayerInfo, nil)
	}
	this.reset()
}
